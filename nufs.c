...
struct stat st;
  ...
  char* single_root = malloc(strlen(path) + strlen(list->data));

  strcpy(single_root,path);

  strcat(single_root,list->data);

  storage_stat(single_root, &st);
